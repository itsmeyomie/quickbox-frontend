-- QuickBox Database Initialization Script
-- Run this script to create the database and initial schema

-- Create database
CREATE DATABASE IF NOT EXISTS quickbox_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
VALUES ('admin@quickbox.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'System Administrator', 'ADMIN', 'ACTIVE')

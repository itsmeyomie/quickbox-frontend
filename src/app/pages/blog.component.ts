  ...
  template: `
    <main>
        ...
        <div class="slider-area">
            <div class="single-slider hero-overly slider-height2 d-flex align-items-center" style="background: linear-gradient(135deg, #001f3f 0%, #003d7a 100%); min-height: 400px;">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
            ...
            <div class="container">
                ...
                <div class="row mb-80">
                    <div class="col-lg-12 text-center">
                        <span style="color: #001f3f; font-size: 16px; letter-spacing: 2px; font-weight: 600;">Resources</span>
                ...
                <div class="row" style="margin: 0 -15px;">
                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0" style="padding: 0 15px;">
                        ...
                        <article style="background: white; border-radius: 20px; padding: 40px; margin-bottom: 40px; box-shadow: 0 5px 25px rgba(0,0,0,0.08); transition: transform 0.3s ease;">
                            <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                                <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #001f3f 0%, #003d7a 100%); border-radius: 15px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                    <span class="flaticon-shipped" style="font-size: 40px; color: white;"></span>
                                </div>
                                <div style="flex: 1;">
                                    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 10px;">
                                        <span style="background: rgba(0,31,63,0.1); color: #001f3f; padding: 5px 15px; border-radius: 20px; font-size: 13px; font-weight: 600;">Delivery Tips</span>
                            ...
                            <div style="display: flex; align-items: center; gap: 30px; padding-top: 20px; border-top: 1px solid #eee;">
                                <span style="color: #001f3f; font-weight: 600; font-size: 15px; display: inline-flex; align-items: center; gap: 8px;">
                                    Featured Article
                                </span>
                        ...
                        <article style="background: white; border-radius: 20px; padding: 40px; margin-bottom: 40px; box-shadow: 0 5px 25px rgba(0,0,0,0.08); transition: transform 0.3s ease;">
                            <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                                ...
                                <div style="flex: 1;">
                                    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 10px;">
                                        <span style="background: rgba(0,31,63,0.1); color: #001f3f; padding: 5px 15px; border-radius: 20px; font-size: 13px; font-weight: 600;">Packaging Guide</span>
                        ...
                        <article style="background: white; border-radius: 20px; padding: 40px; margin-bottom: 40px; box-shadow: 0 5px 25px rgba(0,0,0,0.08); transition: transform 0.3s ease;">
                            <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                                ...
                                <div style="flex: 1;">
                                    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 10px;">
                                        <span style="background: rgba(0,31,63,0.1); color: #001f3f; padding: 5px 15px; border-radius: 20px; font-size: 13px; font-weight: 600;">Business Solutions</span>
                    ...
                    <div class="col-lg-4" style="padding: 0 15px;">
                        ...
                        <div style="background: white; border-radius: 20px; padding: 35px; margin-bottom: 30px; box-shadow: 0 5px 25px rgba(0,0,0,0.08);">
                            <h4 style="color: #333; font-size: 22px; font-weight: 700; margin-bottom: 25px; padding-bottom: 15px; border-bottom: 2px solid #001f3f;">Quick Links</h4>
                            <ul style="list-style: none; padding: 0; margin: 0;">
                                <li style="margin-bottom: 15px;">
                                    <a routerLink="/services" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: #666; transition: color 0.3s; padding: 10px; border-radius: 8px; transition: all 0.3s;">
                                        <span class="flaticon-shipped" style="color: #001f3f; font-size: 20px;"></span>
                                ...
                                <li style="margin-bottom: 15px;">
                                    <a routerLink="/contact" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: #666; transition: color 0.3s; padding: 10px; border-radius: 8px; transition: all 0.3s;">
                                        <span class="flaticon-support" style="color: #001f3f; font-size: 20px;"></span>
                                ...
                                <li style="margin-bottom: 15px;">
                                    <a routerLink="/about" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: #666; transition: color 0.3s; padding: 10px; border-radius: 8px; transition: all 0.3s;">
                                        <span class="flaticon-clock" style="color: #001f3f; font-size: 20px;"></span>
                        ...
                        <!-- Categories Card -->
                        <div style="background: white; border-radius: 20px; padding: 35px; margin-bottom: 30px; box-shadow: 0 5px 25px rgba(0,0,0,0.08);">
                            <h4 style="color: #333; font-size: 22px; font-weight: 700; margin-bottom: 25px; padding-bottom: 15px; border-bottom: 2px solid #001f3f;">Categories</h4>
                            <ul style="list-style: none; padding: 0; margin: 0;">
                                <li style="margin-bottom: 12px;">
                                    <a href="#" style="display: flex; justify-content: space-between; align-items: center; text-decoration: none; color: #666; padding: 10px 0; border-bottom: 1px solid #f0f0f0; transition: color 0.3s;">
                                        ...
                                        <span style="background: #001f3f; color: white; padding: 3px 10px; border-radius: 12px; font-size: 12px; font-weight: 600;">12</span>
                                    </a>
                                </li>
                                <li style="margin-bottom: 12px;">
                                    <a href="#" style="display: flex; justify-content: space-between; align-items: center; text-decoration: none; color: #666; padding: 10px 0; border-bottom: 1px solid #f0f0f0; transition: color 0.3s;">
                                        <span>Packaging</span>
                                        <span style="background: #001f3f; color: white; padding: 3px 10px; border-radius: 12px; font-size: 12px; font-weight: 600;">8</span>
                                    </a>
                                </li>
                                <li style="margin-bottom: 12px;">
                                    <a href="#" style="display: flex; justify-content: space-between; align-items: center; text-decoration: none; color: #666; padding: 10px 0; border-bottom: 1px solid #f0f0f0; transition: color 0.3s;">
                                        <span>Business Solutions</span>
                                        <span style="background: #001f3f; color: white; padding: 3px 10px; border-radius: 12px; font-size: 12px; font-weight: 600;">15</span>
                                    </a>
                                </li>
                                <li style="margin-bottom: 12px;">
                                    <a href="#" style="display: flex; justify-content: space-between; align-items: center; text-decoration: none; color: #666; padding: 10px 0; border-bottom: 1px solid #f0f0f0; transition: color 0.3s;">
                                        <span>Industry News</span>
                                        <span style="background: #001f3f; color: white; padding: 3px 10px; border-radius: 12px; font-size: 12px; font-weight: 600;">10</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <!-- CTA Card -->
                        <div style="background: linear-gradient(135deg, #001f3f 0%, #003d7a 100%); border-radius: 20px; padding: 40px; text-align: center; box-shadow: 0 10px 40px rgba(0,31,63,0.3);">
                            ...
                            <a routerLink="/contact" style="background: white; color: #001f3f; padding: 12px 30px; border-radius: 10px; text-decoration: none; font-weight: 600; display: inline-block; transition: all 0.3s;">
                                Contact Us
                            </a>
                        </div>
                    </div>

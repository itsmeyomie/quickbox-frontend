                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="header-info-left">
                                <ul style="display: flex; gap: 25px; margin: 0; padding: 0; list-style: none; align-items: center;">     
                                    <li style="margin: 0;">Phone: +254118047315</li>
                            ...
                            <div class="header-info-right">
                                <ul class="header-social" style="display: flex; gap: 15px; margin: 0; padding: 0; list-style: none; align-items: center;">    
                                    <li style="margin: 0;"><a href="https://x.com/quickbox26" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white; font-size: 18px;"><i class="fab fa-twitter"></i></a></li>
                                    <li style="margin: 0;"><a href="https://web.facebook.com/quickbox.deliver/" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white; font-size: 18px;"><i class="fab fa-facebook-f"></i></a></li>
                                    <li style="margin: 0;"><a href="https://www.instagram.com/quickbox.delivery/" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white; font-size: 18px;"><i class="fab fa-instagram"></i></a></li>
                                    <li style="margin: 0;"><a href="https://www.tiktok.com/@quickbox.delivery" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white !important; font-size: 18px; display: inline-block; width: 18px; height: 18px; line-height: 18px; text-align: center; opacity: 1;" title="TikTok">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="white" style="display: inline-block; vertical-align: middle; width: 18px; height: 18px;">
                ...
                <div class="footer-heading">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <span class="contact-number f-right">+254118047315</span>
                        </div>
                    </div>
                </div>
                <!-- Footer Menu -->
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul style="list-style: none; padding: 0; margin: 0;">
                                    ...
                                    <li style="margin-bottom: 12px;"><a routerLink="/services" style="text-decoration: none; color: inherit;">COD</a></li>
                                    <li style="margin-bottom: 12px;"><a routerLink="/services" style="text-decoration: none; color: inherit;">On Demand Errand Services</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" style="padding: 0 15px;">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="footer-social" style="display: flex; gap: 15px;">
                                <a href="https://web.facebook.com/quickbox.deliver/" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white; font-size: 20px;" title="Facebook"><i class="fab fa-facebook-f"></i></a>
                                <a href="https://x.com/quickbox26" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white; font-size: 20px;" title="Twitter/X"><i class="fab fa-twitter"></i></a>
                                <a href="https://www.instagram.com/quickbox.delivery/" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white; font-size: 20px;" title="Instagram"><i class="fab fa-instagram"></i></a>
                                <a href="https://www.tiktok.com/@quickbox.delivery" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white !important; font-size: 20px; display: inline-block; width: 20px; height: 20px; line-height: 20px; text-align: center; opacity: 1;" title="TikTok">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white" style="display: inline-block; vertical-align: middle; width: 20px; height: 20px;">
                                        <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" fill="white" stroke="none"/>
                                    </svg>
                                </a>
                            </div>
